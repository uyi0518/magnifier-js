  (function($){
    $.fn.magnifier = function(options){
        ...
        function init() {
                ...
                b_magnifier=$("<div></div>")
                b_magnifier.css({"width": b_width,"height": b_height,"background-color": options.s_magnifier_background_color,"position": "absolute","display": "none","overflow":"hidden","left":_width+"px","top":_top+"px"})
